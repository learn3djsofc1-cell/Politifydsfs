...
- Auth & Dashboard design: light mode with reusable global CSS utilities (sf-card, sf-btn-primary, sf-btn-secondary, sf-input, sf-icon-chip-*, sf-toggle, sf-sidebar, sf-auth-bg/card). Auth pages use gradient bg (#F7F8FA → #EDE9FE → #F0FDF4) with white card panels. Dashboard has dark navy sidebar (#0F1225) with green active indicators, light #F7F8FA main content, white cards with gray-200 borders. Brand colors #9945FF purple and #14F195 green preserved throughout.
